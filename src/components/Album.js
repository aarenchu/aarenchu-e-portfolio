...
import AnsibleScriptsThumbnail from '../assets/imgs/ansiblescriptsthumbnail.png';
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    This service was created for the team to test out the
                    product that the rest of the team is working on.
                  </Typography>
                </CardContent>
                <CardActions>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    This program was created for the team based on requirements
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    These scripts were created for a different team in the
                    company who had originally manually uploaded and published
                    data by themselves.
                  </Typography>
                </CardContent>
                <CardActions>
