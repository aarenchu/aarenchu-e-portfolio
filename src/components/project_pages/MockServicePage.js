        ...
        <div className={classes.heroContent}>
          <Container maxWidth="sm">
            ...
            <Typography variant="p" align="left" color="textSecondary" paragraph>
                ...
                I developed the Python scripts, the authorizer function, which is written in JavaScript, and the database
                by myself, and the rest I had help from my coworker. He also reviewed my code on my scripts.
                For this project, I needed my research skills to find how to develop a schema for a NoSQL database 
                like DynamoDB. I also needed my programming skills to write clean Python scripts, unit tests and the 
                JavaScript Lambda Authorizer function. In addition, I needed my communication skills, since I needed 
                to consult both my supervisor and my coworker when it came to meeting the needs of the project. This 
                project was completed by the time of the demo. Following the code review, I received positive feedback
